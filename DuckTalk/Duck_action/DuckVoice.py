...
with open("/home/cristian/Desktop/testDuck/DuckTalk/models/voice/model4.onnx.json", "r", encoding="utf-8") as f:
    config_dict = json.load(f)
config = PiperConfig.from_dict(config_dict)
voice = PiperVoice.load("/home/cristian/Desktop/testDuck/DuckTalk/models/voice/model4.onnx")
