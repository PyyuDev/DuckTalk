...
function insertarDiv() {
  ...
  const fontUrl = chrome.runtime.getURL("MickeyMousePersonalUseRegular-mLRAG.otf");

// 2. Crear e inyectar los estilos con la fuente personalizada
...
fontStyle.textContent = `
  ...
  Object.assign(div.style, {
    ...
    borderRadius: "5px",
    fontFamily: "Arial",
    fontFamily: "MiFuente3, sans-serif",
    width: "300px",
    height: "370px",
    overflow: "auto",
    display: "flex",
...
function showToast(message = "Algo salió mal") {
  ...
  // Crear imagen (opcional)
    ...
    imgduck.src = chrome.runtime.getURL("icon2.png");
    imgduck.alt = "icono";
